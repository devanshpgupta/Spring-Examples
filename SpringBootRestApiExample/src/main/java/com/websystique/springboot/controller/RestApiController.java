...
public class RestApiController {
	...
	//@RequestHeader(value="User-Agent") String userAgent, @RequestHeader(value="Access-Control-Allow-Origin") String allow
	@CrossOrigin(origins = "http://localhost:8089")
	@RequestMapping(produces = "application/json", value = "/user/", method = RequestMethod.GET)
	public ResponseEntity<List<User>> listAllUsers(@RequestHeader(value="User-Agent") String userAgent) {
	...
	@RequestMapping(produces = "application/json", value = "/user/", method = RequestMethod.DELETE)
